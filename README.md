...
A personal learning repository built alongside CS50P — not as a course submission, but as a self-directed study log. Every folder here is something I built while working through the material from scratch, starting March 27, 2026 with zero prior coding experience.
...
This is not a polished portfolio. It's a record of learning in progress — messy in places, iterative throughout. Some files exist purely to test one idea. Some master challenges have rough edges that a later week's knowledge would fix.

That's intentional. This is what actually learning looks like.
...
| Week | Core concepts introduced |
|------|--------------------------|
| 0 | Functions, variables, f-strings, user input |
| 1 | Conditionals, match statements, exceptions |
| 2 | Loops, lists, dictionaries |
| 3 | Exception handling, error raising |
| 4 | Libraries, APIs, external packages |
| 5 | Unit testing with pytest |
| 6 | File I/O, CSV, OS, PIL |
| 7 | Regular expressions |
| 8 | Object-oriented programming, classes |
| 9 | Type hints, argparse, generators, recursion |

---

> Started March 27, 2026. No prior experience.